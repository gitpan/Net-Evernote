      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem242 = undef;
            $elem242 = new EDAMTypes::SharedNotebook();
            $xfer += $elem242->read($input);
            push(@{$self->{success}},$elem242);
          }
          $xfer += $input->readListEnd();
        }
      } else {
...
sub write {
  ...
  if (defined $self->{success}) {
    $xfer += $output->writeFieldBegin('success', TType::LIST, 0);
    {
      $xfer += $output->writeListBegin(TType::STRUCT, scalar(@{$self->{success}}));
      {
        foreach my $iter243 (@{$self->{success}}) 
        {
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          for (my $_i248 = 0; $_i248 < $_size244; ++$_i248)
          {
            ...
            push(@{$self->{sharedNotebookIds}},$elem249);
          }
          $xfer += $input->readListEnd();
        }
      } else {
...
sub write {
  ...
  if (defined $self->{sharedNotebookIds}) {
    $xfer += $output->writeFieldBegin('sharedNotebookIds', TType::LIST, 2);
    {
      ...
      {
        foreach my $iter250 (@{$self->{sharedNotebookIds}}) 
        {
          $xfer += $output->writeI64($iter250);
        }
      }
      $xfer += $output->writeListEnd();
    }
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem256 = undef;
            $elem256 = new EDAMTypes::LinkedNotebook();
